...
CREATE TABLE `orders` (
  ...
  `spName` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `spCauhinh` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `spHang` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `so_luong` int DEFAULT NULL,
  `spGia` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
